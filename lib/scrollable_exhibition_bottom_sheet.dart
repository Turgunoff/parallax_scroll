...
final List<Event> events = [
  Event('ice_city.jpeg', 'Shenzhen GLOBAL DESIGN AWARD 2018'),
  Event('magic_city.jpeg', 'Shenzhen GLOBAL DESIGN AWARD 2018'),
  Event('tashkent_city.jpeg', 'Dawan District Guangdong Hong Kong'),
  Event('seoul_mun.jpeg', 'Dawan District Guangdong Hong Kong'),
  Event('ice_city.jpeg', 'Shenzhen GLOBAL DESIGN AWARD 2018'),
  Event('magic_city.jpeg', 'Shenzhen GLOBAL DESIGN AWARD 2018'),
  Event('tashkent_city.jpeg', 'Dawan District Guangdong Hong Kong'),
  Event('seoul_mun.jpeg', 'Dawan District Guangdong Hong Kong'),
...
class Event {
  ...
  Event(this.assetName, this.title);
}
